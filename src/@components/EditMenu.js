...
function EditMenu({ open, data }) {
  ...
  const handleClick = (e) => {
    ...
    const data = {
      ...
      orderTimes: form.orderTimes,
      services: form.services,
      applicableHours: form.applicableHours,
      enableAgeRestrictedAccess: form.enableAgeRestrictedAccess,
      enablePreOrdersOnly: form.enablePreOrdersOnly,
      preOrdersDaysInAdvance: form.preOrdersDaysInAdvance,
      preOrdersCutoffTime: form.preOrdersCutoffTime,
    };
    if (form.name != "") {
